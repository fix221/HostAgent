...
export const builtinAnimeThemes: AnimeTheme[] = [
  {
    ...
    name: '哥伦比亚',
    description: '原神 - 哥伦比亚',
    pcBackground: 'https://p3-pc-sign.douyinpic.com/tos-cn-i-0813c001/oMN7GYIAAAfSJwGIBkEFIxAEGeAYLBAieEASEI~tplv-dy-aweme-images:q75.webp?biz_tag=aweme_images&from=327834062&lk3s=138a59ce&s=PackSourceEnum_SEARCH&sc=image&se=false&x-expires=1779915600&x-signature=FOhihD9eM1nllN0jdmg2YePoalA%3D',
    mobileBackground: 'https://p3-pc-sign.douyinpic.com/tos-cn-i-0813c001/oMN7GYIAAAfSJwGIBkEFIxAEGeAYLBAieEASEI~tplv-dy-aweme-images:q75.webp?biz_tag=aweme_images&from=327834062&lk3s=138a59ce&s=PackSourceEnum_SEARCH&sc=image&se=false&x-expires=1779915600&x-signature=FOhihD9eM1nllN0jdmg2YePoalA%3D',
    primaryColor: '#7bc862',
    accentColor: '#4caf50',
    thumbnail: 'https://p3-pc-sign.douyinpic.com/tos-cn-i-0813c001/oQIBCLR9vEAxByGVQe0HAEAAIqebeAkLxEGA7M~tplv-dy-aweme-images-v2:3000:3000:q75.webp?biz_tag=aweme_images&from=327834062&lk3s=138a59ce&s=PackSourceEnum_SEARCH&sc=image&se=false&x-expires=1779912000&x-signature=0SdVYLEAaDV3k2exObkGaXq9Y6w%3D',
    builtin: true,
  }, {
    id: 'pikachu',
    name: '皮卡丘',
